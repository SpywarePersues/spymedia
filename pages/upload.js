...
function upload() {
    ...
    return (
        <ContainerBlock title="Upload">
            ...
            <input className='mx-6 rounded-md glassmorph my-2 w-11/12 h-12 p-4 text-gray-300 outline-none' onChange={event => setName(event.target.value)} />
            ...
            <textarea className='mx-6 rounded-md glassmorph mt-2 mb-6 w-11/12 h-[10rem] p-4 text-gray-300 outline-none' onChange={event => setDesc(event.target.value)} />
